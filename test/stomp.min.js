  ...
  t = (function () {
          ...
          f =
            typeof ArrayBuffer !== "undefined" && c.data instanceof ArrayBuffer
              ? ((a = new Uint8Array(c.data)),
                typeof s.debug === "function"
                  ? s.debug("--- got data length: " + a.length)
                  : void 0,
                r(a))
              : c.data;
          s.serverActivity = t();
    ...
    r.prototype._schedule_reconnect = function () {
      if (this.reconnect_delay > 0) {
        if (typeof this.debug === "function") {
          this.debug(
            "STOMP: scheduling reconnection in " + this.reconnect_delay + "ms",
          );
        }
            ...
            return function () {
              if (e.connected) {
                return typeof e.debug === "function"
                  ? e.debug("STOMP: already connected")
                  : void 0;
              } else {
                if (typeof e.debug === "function") {
      ...
      if (this.connected) {
        ...
        try {
          ...
          return typeof this.debug === "function"
            ? this.debug("Ignoring error during disconnect", n)
            : void 0;
        }
      }
    };
